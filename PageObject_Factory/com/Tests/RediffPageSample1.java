...
import com.Pages.RediffMailShoppingPage1;

public class RediffPageSample1 {
	...
	public void SampleTest() throws InterruptedException {
		...
		RediffMailShoppingPage1 obj3 = new RediffMailShoppingPage1(driver);
		
		obj3.SetlowpriceTxtBox().sendKeys("1000");
		
		obj3.SethighpriceTxtBox().sendKeys("2000");
		
		obj3.SetpriceGoBtn().click();
...
Starting ChromeDriver 2.45.615291 (ec3682e3c9061c10f26ea9e5cdcf3c53f3f74387) on port 12615
Only local connections are allowed.
Mar 25, 2019 1:47:51 PM org.openqa.selenium.remote.ProtocolHandshake createSession
